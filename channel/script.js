...
function closeModal() {document.querySelector("dialog[open]").close();};
document.onclick = event => {if(!event.target.closest("dialog[open] .dialog")){closeModal();console.log("if");}else{console.log("else");};};
